...
VnStock supports two primary data sources:

| Source | Description | Recommended For |
|--------|-------------|-----------------|
| **VCI** | VNDirect data | Price history, financial statements, company overview |
| **TCBS** | TCBS Securities | Screener, dividends, insider trading, detailed events |

```python
# VCI source (recommended for most operations)
stock = Vnstock().stock(symbol='VCI', source='VCI')

# TCBS source (for screener and some company data)
...
*Documentation generated from vnstocks.com/docs - Last updated: 2026-01-02*
